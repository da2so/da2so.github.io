...
<img src="https://da2so.github.io/assets/post_img/2020-08-10-GradCAM/3.png" width="300" height="200" style="float: left">
...
Obtaining the neuron importance weights <span style="color:DodgerBlue">$w^{c}_{k}=\frac{1}{z}$</span>
...
The, we perform a weighted combination of forward activation
