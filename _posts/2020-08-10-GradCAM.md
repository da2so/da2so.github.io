...
{: .box-note}
**Note:** Note that I (da2so) will only deal with the problem of an image classification in the following contents.

![2](https://da2so.github.io/assets/post_img/2020-08-10-GradCAM/2.png){: .mx-auto.d-block :}


![3](https://da2so.github.io/assets/post_img/2020-08-10-GradCAM/2.png){: style="float: left" width: 200px}
