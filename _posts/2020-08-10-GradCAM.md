...
The property of <span style="color:blue">$A^k$</span>: We expect the last convolution layer to have the best comprise between high-level semantics and detailed spatial information


Obtaining the neuron importance weights <span style="color:blue">$w^{c}_{k}=\frac{1}{z}\sum_i\sum_j\frac{\partial y^c}{\partial A^{k}_{i,j}}$</span>
