...
![1](post_img/2020-08-10-GradCAM/1.png){: .mx-auto.d-block :}
...
<span style="color:gray">"Note that I (da2so) will only deal with the problem of an image classification in the following contents."</span>
