...
{% include image.html url="https://da2so.github.io/assets/post_img/2020-08-10-GradCAM/3.png" description="The overall procedure of GradCAM" %}

<figure class="image">

  <img src="https://da2so.github.io/assets/post_img/2020-08-10-GradCAM/3.png" width="300" height="250" style="float: left">
  <figcaption>{{ The overall procedure of GradCAM }}</figcaption>
</figure>
...
Obtaining the neuron importance weights <span style="color:DodgerBlue">$w^{c}_{k}=\frac{1}{z} \sum$</span>
